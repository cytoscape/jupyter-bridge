...
if "_PY4CYTOSCAPE_CHANNEL" in globals():
  if RunningInCOLAB:
    print('Re-initialization does not work properly in Colab ... restarting Kernel. Restart your notebook.')
    exit()
  print(f'Skip loading Javascript client ... {_PY4CYTOSCAPE_CHANNEL} on {p4c.get_jupyter_bridge_url()}')
  browser_client_js = '' # Add nothing to the browser's Javascript
else:
